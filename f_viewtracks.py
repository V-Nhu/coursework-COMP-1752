...
class TrackViewer():
    ...
    def view_tracks_clicked(self):
        ...
        if name is not None:
            ...
            self.status_lbl.configure(text=f"Track {key} was successfully found in the library.", fg="green")

        else:
            set_text(self.track_txt, f"Track {key} not found")
            self.status_lbl.configure(text=f"Track {key} not found in library. Please try a different number.", fg="red")
    ...
    def list_tracks_clicked(self):
        ...
        self.status_lbl.configure(text="All tracks displayed successfully.", fg="green")
        self.track_txt.delete("1.0", tk.END)
        self.track_txt.insert(tk.END, "")
